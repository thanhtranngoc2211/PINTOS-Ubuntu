...
struct partition
{
  ...
  block_sector start;  /* First sector within device. */
};

static struct block_operations partition_operations;

static void read_partition_table(struct block *, block_sector sector,
                                 block_sector primary_extended_sector,
                                 int *part_nr);
static void found_partition(struct block *, uint8_t type,
                            block_sector start, block_sector size,
                            int part_nr);
...
static void
read_partition_table(struct block *block, block_sector sector,
                     block_sector primary_extended_sector,
                     int *part_nr)
{
...
static void
partition_read(void *p_, block_sector sector, void *buffer)
{
...
static void
partition_write(void *p_, block_sector sector, const void *buffer)
{
  struct partition *p = p_;
