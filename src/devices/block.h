...
block_sector block_size(struct block *);
void block_read(struct block *, block_sector, void *);
void block_write(struct block *, block_sector, const void *);
...
{
  void (*read)(void *aux, block_sector, void *buffer);
  void (*write)(void *aux, block_sector, const void *buffer);
};

struct block *block_register(const char *name, enum block_type,
                             const char *extra_info, block_sector size,
